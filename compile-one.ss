#!chezscheme
;;; compile-one.ss — Compile a single gerbil-aws module to .sls via Gherkin compiler
;;; Usage: scheme -q --libdirs src:<gherkin-path> --compile-imported-libraries --program compile-one.ss <source-path> <flat-name>
...
(define submodule-dir "gerbil-aws")
(define output-dir "src/gerbil-aws")
...
(define gerbil-aws-import-map
  '((*default-package* . gerbil-aws)
    (:gerbil/compiler . #f)
    (:gerbil/expander . #f)
    ...
    (:gerbil-aws/aws/api . (gerbil-aws aws-api))
    (:gerbil-aws/rds/api . (gerbil-aws rds-api))
    (:gerbil-aws/aws/creds . (gerbil-aws aws-creds))
    (:gerbil-aws/ec2/nat-gateways . (gerbil-aws ec2-nat-gateways))
    (:gerbil-aws/cfn/api . (gerbil-aws cfn-api))
    (:gerbil-aws/iam/policies . (gerbil-aws iam-policies))
    (:gerbil-aws/ec2/volumes . (gerbil-aws ec2-volumes))
    (:gerbil-aws/ec2/subnets . (gerbil-aws ec2-subnets))
    (:gerbil-aws/lambda/functions . (gerbil-aws lambda-functions))
    (:gerbil-aws/ec2/instances . (gerbil-aws ec2-instances))
    (:gerbil-aws/s3/api . (gerbil-aws s3-api))
    (:std/text/hex . #f)
    (:gerbil-aws/sqs/api . (gerbil-aws sqs-api))
    (:gerbil-aws/aws/json-api . (gerbil-aws aws-json-api))
    (:gerbil-aws/ec2/key-pairs . (gerbil-aws ec2-key-pairs))
    (:gerbil-aws/sts/api . (gerbil-aws sts-api))
    (:std/misc/bytes . #f)
    (:std/text/base64 . #f)
    (:gerbil-aws/ec2/network-interfaces . (gerbil-aws ec2-network-interfaces))
    (:gerbil-aws/s3/xml . (gerbil-aws s3-xml))
    (:gerbil-aws/ec2/images . (gerbil-aws ec2-images))
    (:gerbil-aws/logs/operations . (gerbil-aws logs-operations))
    (:gerbil-aws/sts/operations . (gerbil-aws sts-operations))
    (:gerbil-aws/iam/api . (gerbil-aws iam-api))
    (:gerbil-aws/iam/roles . (gerbil-aws iam-roles))
    (:gerbil-aws/ec2/internet-gateways . (gerbil-aws ec2-internet-gateways))
    (:gerbil-aws/cfn/stacks . (gerbil-aws cfn-stacks))
    (:gerbil-aws/ec2/tags . (gerbil-aws ec2-tags))
    (:gerbil-aws/sqs/operations . (gerbil-aws sqs-operations))
    (:gerbil-aws/s3/objects . (gerbil-aws s3-objects))
    (:gerbil-aws/ec2/security-groups . (gerbil-aws ec2-security-groups))
    (:gerbil-aws/ssm/operations . (gerbil-aws ssm-operations))
    (:gerbil-aws/logs/api . (gerbil-aws logs-api))
    (:gerbil-aws/cloudwatch/api . (gerbil-aws cloudwatch-api))
    (:gerbil-aws/compute-optimizer/api . (gerbil-aws compute-optimizer-api))
    (:gerbil-aws/ec2/snapshots . (gerbil-aws ec2-snapshots))
    (:gerbil-aws/ec2/xml . (gerbil-aws ec2-xml))
    (:std/srfi/19 . #f)
    (:gerbil-aws/ec2/api . (gerbil-aws ec2-api))
    (:std/net/websocket . #f)
    (:std/net/request . #f)
    (:gerbil-aws/ec2/addresses . (gerbil-aws ec2-addresses))
    (:gerbil-aws/ec2/launch-templates . (gerbil-aws ec2-launch-templates))
    (:gerbil-aws/dynamodb/api . (gerbil-aws dynamodb-api))
    (:std/cli/getopt . (compat getopt))
    (:gerbil-aws/ec2/vpcs . (gerbil-aws ec2-vpcs))
    (:std/net/s3/sigv4 . #f)
    (:gerbil-aws/lambda/api . (gerbil-aws lambda-api))
    (:gerbil-aws/ec2/regions . (gerbil-aws ec2-regions))
    (:gerbil-aws/aws/xml . (gerbil-aws aws-xml))
    (:gerbil-aws/cli/format . (gerbil-aws cli-format))
    (:gerbil-aws/iam/groups . (gerbil-aws iam-groups))
    (:gerbil-aws/ssm/api . (gerbil-aws ssm-api))
    (:gerbil-aws/s3/buckets . (gerbil-aws s3-buckets))
    (:gerbil-aws/cost-optimization-hub/api . (gerbil-aws cost-optimization-hub-api))
    (:std/crypto/digest . #f)
    (:gerbil-aws/sns/api . (gerbil-aws sns-api))
    (:std/markup/xml . #f)
    (:gerbil-aws/elbv2/api . (gerbil-aws elbv2-api))
    (:gerbil-aws/dynamodb/operations . (gerbil-aws dynamodb-operations))
    (:gerbil-aws/iam/users . (gerbil-aws iam-users))
    (:gerbil-aws/ssm/session . (gerbil-aws ssm-session))
    (:std/text/json . (compat json))
    (:gerbil-aws/iam/access-keys . (gerbil-aws iam-access-keys))
    (:gerbil-aws/ec2/params . (gerbil-aws ec2-params))
    (:std/net/uri . #f)
    (:gerbil-aws/sns/operations . (gerbil-aws sns-operations))
    (:gerbil-aws/ec2/route-tables . (gerbil-aws ec2-route-tables))
    ))

(define gerbil-aws-base-imports
...
(define (lib-name->sls-path lib-name)
  (cond
    ((and (pair? lib-name) (= (length lib-name) 2) (eq? (car lib-name) 'gerbil-aws))
...
(define (compile-module source-path flat-name)
  (let* ((input-path (find-source source-path))
         ...
         (lib-name `(gerbil-aws ,(string->symbol flat-name))))
    ...
    (guard (exn
      ...
      (let* ((lib-form (gerbil-compile-to-library
                         input-path lib-name gerbil-aws-import-map gerbil-aws-base-imports))
...
(let ((args (cdr (command-line))))
  (unless (= (length args) 2)
    (display "Usage: scheme --program compile-one.ss <source-path> <flat-name>\n")
    (exit 1))
  (compile-module (car args) (cadr args)))
